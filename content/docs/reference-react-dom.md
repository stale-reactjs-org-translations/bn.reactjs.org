...
`react-dom` প্যাকেজ আপনাকে DOM সম্পর্কিত কিছু মেথড প্রদান করে যা আপনি আপনার এপের top-level এ ব্যবহার করতে পারেন। আপনি এর মাধ্যমে প্রয়োজন অনুযায়ী React মডেল থেকেও বেরিয়ে আসতে পারেন। আপনার অধিকাংশ component এরই এই মডিউল এর প্রয়োজন হবেনা।
...
> বিঃদ্রঃ
>
> আমরা পুরনো ব্রাউজার গুলো সাপোর্ট করিনা যাতে ES5 মেথড এর সাপোর্ট নেই, কিন্তু আপনি হয়তো দেখবেন আপনার এপ পুরনো ব্রাউজারেও ঠিকমতই চলছে যদি আপনি [es5-shim এবং es5-sham](https://github.com/es-shims/es5-shim) এর মত পলিফিল গুলো আপনার পেইজে সংযুক্ত করেন। কিন্তু এক্ষেত্রে আপনি সম্পূর্ণ আপনার উপর।
