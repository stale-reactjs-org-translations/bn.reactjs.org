...
এই অনুচ্ছেদে আমরা এমন কিছু সমস্যা নিয়ে আলোচনা করব যেসব ক্ষেত্রে React এ নতুন ডেভেলপাররা অধিকাংশ সময়েই ইনহ্যারিটেন্স ব্যবহার করে, এবং কিভাবে আমরা এই সমস্যাগুলো কম্পোজিশনের মাধ্যমে সমাধান করতে পারি।
...
অনেক সময় আমরা কম্পোনেন্টকে চিন্তা করি অন্যান্য কম্পোনেন্টের "বিশেষ ক্ষেত্র" হিসেবে। উদাহরণস্বরূপ, আমরা বলতে পারি `WelcomeDialog` হল `Dialog` এর একটি বিশেষ ক্ষেত্র।
...
## তাহলে ইনহ্যারিটেন্স? {#so-what-about-inheritance}
