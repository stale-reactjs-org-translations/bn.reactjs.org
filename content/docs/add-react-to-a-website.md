...
বেশির ভাগ ওয়েবসাইটের ক্ষেত্রেই সেগুলো সিঙ্গেল পেজ অ্যাপ্লিকেশান হওয়া জরুরী নয়। শুধুমাত্র **কয়েক লাইন কোড লিখে এবং বিশাল টুল চেইন ছাড়ায়** আপনার ওয়েবসাইটের ছোট্ট কোন অংশে React ব্যবহার করতে পারেন। অতঃপর আপনার প্রয়োজন মত ধীরে ধীরে এর ব্যবহার বৃদ্ধি করতে পারেন অথবা অল্প কিছু উইজেট হিসেবেই এর ব্যবহার সীমাবদ্ধ রাখতে পারেন।
...
এই অনুচ্ছেদে আমরা আপনাকে দেখাবো যে কিভাবে একটি HTML পেজে React  কম্পোনেন্ট সংযুক্ত করা যায়। আপনি চাইলে আপনার বর্তমান ওয়েবসাইটিতেই আমাদেরকে অনুসরণ করে প্র্যাকটিস করতে পারেন অথবা একটি নতুন HTML পেজ তৈরি করে প্র্যাকটিস করতে পারেন।

এক্ষেত্রে কোন জটিল টুলস বা ইন্সটল করার ঝামেলা নেই -- **এই অনুচ্ছেদটি সম্পূর্ণ করতে প্রয়োজন শুধুমাত্র একটি ইন্টারনেট কানেকশন এবং আপনার মূল্যবান এক মিনিট সময়।**
...
### ধাপ-১: HTML এ একটি DOM কন্টেইনার সংসংযুক্ত করুন {#step-1-add-a-dom-container-to-the-html}
...
এখন **[এই স্টারটার কোডটি খুলুন](https://cdn.rawgit.com/gaearon/0b180827c190fe4fd98b4c7f570ea4a8/raw/b9157ce933c79a4559d2aa9ff3372668cce48de7/LikeButton.js)** এবং কপি করে আপনার সদ্য তৈরি করা `like_button.js` ফাইলে পেস্ট করুন।
...
এখন **[এই স্টারটার কোড](https://gist.github.com/gaearon/0b180827c190fe4fd98b4c7f570ea4a8/raw/b9157ce933c79a4559d2aa9ff3372668cce48de7/LikeButton.js)** এর সাথে `like_button.js` ফাইলের শেষে নিচের দুই লাইন কোড সংযুক্ত করুনঃ
...
এই দুই লাইন কোড HTML পেজের কাঙ্ক্ষিত `<div>` ট্যাগটি খুঁজে বের করবে এবং সেখানে আমাদের "Like" বাটনের জন্য তৈরি React কম্পোনেন্টটি দেখবে।

### কাজ শেষ! {#thats-it}

আর কোন ধাপ বাকি নেই। **আপনি আপনার প্রথম React কম্পোনেন্টটি সফলভাবে আপনার ওয়েবসাইটে সংযুক্ত করেছেন।**

পরবর্তী অনুচ্ছেদ ভিজিট করুন কিভাবে React ইনটিগ্রেট করতে হয় তা দেখার জন্য।
...
### পরামর্শ: প্রোডাকশনের জন্য জাভাস্ক্রিপ্টকে মিনিফাই করুন {#tip-minify-javascript-for-production}
...
উপরের কোড দুইটি একে অপরের সমতুল্য। এখানে **JSX একটি [সম্পূর্ণ অপশনাল ফিচার](/docs/react-without-jsx.html)**, অনেকেই UI কোড লেখার জন্য JSX কে সহায়ক মনে করেন এবং এই স্বাচ্ছন্দ React ও অন্যান্য লাইব্রেরির ক্ষেত্রেও।
...
>নোট
>
>আমরা এখানে **npm ব্যবহার করেছি শুধুমাত্র JSX প্রিপ্রসেসর ইন্সটল করার জন্য** এছাড়া অন্য কিছু আপনার দরকার নেই। React ও অ্যাপলিকেশনের কোড আগের মতই `<script>` ট্যাগসহ আছে, কোন পরিবর্তন ছাড়ায়।
...
আপনি যদি মনে করেন, এখন আপনি মোটামুটি বিলড টুলস গুলোতে স্বাচ্ছন্দ্যবোধ করছেন এবং নিজের প্রোজেক্টের প্রয়োজনে ব্যবহার করতে পারবেন। [পরবর্তী অনুচ্ছেদে](/docs/create-a-new-react-app.html) বেশ কিছু জনপ্রিয় টুলচেইন নিয়ে আলোচনা করা হয়েছে। যদি তা না চান, তবে এই স্ক্রিপ্ট ট্যাগগুলো ভালমত কাজ করবে।