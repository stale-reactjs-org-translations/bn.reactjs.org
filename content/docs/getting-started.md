...
React ডিজাইন করা হয়েছে ধীরে ধীরে গ্রহণযোগ্যতার সাথে মানিয়ে নেয়ার জন্য। **আপনি আপনার প্রয়োজনে যতটুকু দরকার ঠিক ততটুকু React ব্যবহার করতে পারেন।** আপনি যেভাবে খুশি React এর স্বাদ নিতে পারেন, চাইলে একটি HTML ডকুমেন্টে React ব্যবহার করতে পারেন আবার চাইলে জটিল ও বড় কোন প্রোজেক্টে React ব্যবহার করে দেখতে পারেন। নিচের লিঙ্কগুলো আপনাকে শুরু করতে সহায়তা করবে।
...
=======
আমরা আপনাকে প্রথমে [এই জাভাস্ক্রিপ্ট ওভারভিউ](https://developer.mozilla.org/en-US/docs/Web/JavaScript/A_re-introduction_to_JavaScript) থেকে আপনার জাভাস্ক্রিপ্ট সম্পর্কিত জ্ঞান যাচায় করতে পরামর্শ দিচ্ছি। এ জন্য আপনার ১ ঘণ্টা ৩০ মিনিটের মত সময় লাগতে পারে, কিন্তু এর পর আপনার জন্য React শিখা অনেক সহজ হয়ে যাবে।

>>>>>>> resolve @nutboltu issues and impreadability
>পরামর্শ
>
