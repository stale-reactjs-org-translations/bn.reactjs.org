...
আমরা আপনাকে প্রথমে [মোজিলা ডেভেলপার নেটওয়ার্ক](https://developer.mozilla.org/en-US/docs/Web/JavaScript/A_re-introduction_to_JavaScript) থেকে আপনার জাভাস্ক্রিপ্ট সম্পর্কিত জ্ঞান যাচায় করতে পরামর্শ দিচ্ছি। এ জন্য আপনার ১ ঘণ্টা ৩০ মিনিটের মত সময় লাগতে পারে, কিন্তু এর পর আপনার জন্য React শিখা অনেক সহজ হয়ে যাবে। 
