...
React ডিজাইন করা হয়েছে ধীরে ধীরে গ্রহণযোগ্যতার সাথে মানিয়ে নেয়ার জন্য। **আপনি আপনার প্রয়োজনে যতটুকু দরকার ঠিক তততুকু React ব্যবহার করতে পারেন।** আপনি যেভাবে খুশি React এর স্বাদ নিতে পারেন, চাইলে একটি HTML ডকুমেন্টে React ব্যবহার করতে পারেন আবার চাইলে জটিল ও বড় কোন প্রোজেক্ট এ React ব্যবহার করে দেখতে পারেন। নিচের লিঙ্কগুলো আপনাকে শুরু করতে সহায়তা করবে।
...
=======
আমরা আপনাকে প্রথমে [মোজিলা ডেভেলপার নেটওয়ার্ক](https://developer.mozilla.org/en-US/docs/Web/JavaScript/A_re-introduction_to_JavaScript) থেকে জাভাস্ক্রিপ্ট সম্পর্কে ধারণা নিতে পরামর্শ দিচ্ছি। এ জন্য আপনার ৩০ মিনিট থেকে ১ ঘণ্টা সময় লাগতে পারে, কিন্তু এর পর আপনার জন্য React শিখা অনেক সহজ হয়ে যাবে। 
>>>>>>> resolve commented issues and update readability
>পরামর্শ
>
...
এই [শব্দকোষ বা গ্লসারি পেজটিতে](/docs/glossary.html) React ডকুমেন্টেশন এর কমন বিষয় সমুহের একটি সুন্দর সারমর্ম আছে। এছাড়াও একটি FAQ অনুচ্ছেদ আছে, যেখানে আপনি আপনার কাঙ্ক্ষিত কমন প্রশ্ন সমুহের উত্তর পেতে পারেন। যেমন ধরুন একটি [AJAX রিকুয়েস্ট](/docs/faq-ajax.html) কিভাবে দিতে হয়, [কম্পোনেন্ট স্টেট](/docs/faq-state.html) কি বা React প্রোজেক্টে [ফাইল এর গঠন](/docs/faq-structure.html) কেমন হতে পারে এগুলো জানতে পারবেন।
...
প্রতিটি React রিলিজ নোটের জন্যই ব্লগ পোস্ট লেখার প্রয়োজন পড়ে না কিন্তু আপনি এ বিষয়ে [React রিপোজিটোরির changelog](https://github.com/facebook/react/blob/master/CHANGELOG.md) পাতাটি থেকে বিস্তারিত জানতে পারবেন। এছাড়াও [রিলিজ পাতা টিতেও](https://github.com/facebook/react) বিস্তারিত দেয়া থাকে।
