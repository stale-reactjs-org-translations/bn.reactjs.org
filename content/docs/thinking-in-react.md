...
এখানে আপনি দেখবেন যে আমাদের অ্যাপ এ পাঁচটি কম্পোনেন্ট রয়েছে। আমরা প্রতিটা কম্পোনেন্ট এর উপস্থাপিত ডেটা ইটালিক করে দিয়েছি। ছবির সংখ্যাগুলো নিচের সংখ্যাগুলোর অনুরুপ।
...
উদাহরণের অ্যাপের প্রতিটি ডেটার কথা আবার চিন্তা করুন। আমাদের কাছে আছেঃ
...
যদি আপনি আগের উদাহরণে(ধাপ ৪) টাইপ করতে বা টিক দেয়ার চেষ্টা করেন, তাহলে দেখবেন React আপনার ইনপুট অগ্রাহ্য করছে। এটি ইচ্ছা করেই করা হয়েছে, যেহেতু আমরা `input` এর `value` prop সবসময় `FilterableProductTable` থেকে প্রেরিত `state` এর মতো রাখছি।
